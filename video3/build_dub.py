...
Usage: python video3/build_dub.py [gen|build|all]
"""
...
SENT = Path("video3/audio/dubbing_sentences")
SRC = "video3/source/20211121 洪水重臨.mp4"
OUT_WAV = Path("video3/audio/english_dub.wav")
OUT_MP4 = "video3/output/final_english_v2.mp4"
END = re.compile(r'[.!?…]["\')\]]?\s*$')
...
def build():
    ...
    Path("video3/output").mkdir(parents=True, exist_ok=True)
