...
-> video3/transcripts/rewrite_list.md / .json  (no API, no audio written)
"""
import re, subprocess, json, statistics as st
from pathlib import Path

EN = Path("video3/transcripts/subtitles_en.srt")
ZH = Path("video3/transcripts/subtitles_zh.srt")
...
Path("video3/transcripts/rewrite_list.md").write_text("\n".join(md))
json.dump(out, open("video3/transcripts/rewrite_list.json", "w"), ensure_ascii=False, indent=2)
print(f"\nWrote video3/transcripts/rewrite_list.md and .json")
