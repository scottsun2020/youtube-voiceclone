...
Usage: python video4/build_dub.py [gen|build|all]
"""
...
SEG = Path("video4/audio/segments_v3")
SENT = Path("video4/audio/dubbing_sentences")
SRC = "video4/source/test_1min.mp4"
OUT_WAV = Path("video4/audio/test1min_dub_v3.wav")
OUT_MP4 = "video4/output/test1min_ours_v3.mp4"
END = re.compile(r'[.!?…]["\')\]]?\s*$')
...
def build():
    ...
    Path("video4/output").mkdir(parents=True, exist_ok=True)
